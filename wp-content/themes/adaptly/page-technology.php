  ...
  <?php while ( have_posts() ) : the_post(); ?>
    ...
    <div class="computer-animation">
      ...
      <div class="video-container">
        ...
        <source src="<?php echo get_template_directory_uri(); ?>/images/technology_animation_updated.ogv" type="video/ogv">
        <source src="<?php echo get_template_directory_uri(); ?>/images/technology_animation_updated.webm" type="video/webm">
        <source src="<?php echo get_template_directory_uri(); ?>/images/technology_animation_updated.mp4" type="video/mp4">
